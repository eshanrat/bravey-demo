...
const recipes: Recipe[] = [
  ...
  },
  {
    ...
    description: 'Light, airy pancakes perfect for a weekend morning. Serve with maple syrup and berries.',
    category: 'breakfast',
    prepMins: 10,
    cookMins: 15,
    servings: 4,
    ...
    ingredients: [
      ...
      { amount: '300', unit: 'ml', name: 'buttermilk' },
      { amount: '2', unit: '', name: 'large eggs' },
      { amount: '50', unit: 'g', name: 'unsalted butter, melted' },
      { amount: '1', unit: 'tsp', name: 'vanilla extract' },
    ],
    steps: [
      'Whisk flour, sugar, baking powder, and salt in a large bowl.',
      'In another bowl, whisk buttermilk, eggs, melted butter, and vanilla.',
      'Pour wet ingredients into dry and gently fold until just combined — lumps are fine.',
      'Heat a non-stick pan over medium heat. Pour 1/4 cup batter per pancake.',
      'Cook until bubbles form on surface and edges look set, about 2-3 minutes. Flip and cook 1-2 minutes more.',
      'Serve immediately with maple syrup, berries, and butter.',
    ],
  ...
  },
  {
    ...
    description: 'Creamy, refreshing matcha latte with vanilla oat milk. Perfect for warm afternoons.',
    category: 'drink',
    prepMins: 5,
    cookMins: 0,
    servings: 1,
    ...
    ingredients: [
      { amount: '1', unit: 'tsp', name: 'ceremonial matcha powder' },
      { amount: '2', unit: 'tbsp', name: 'hot water (80°C)' },
      { amount: '1', unit: 'tbsp', name: 'maple syrup or honey' },
      { amount: '200', unit: 'ml', name: 'vanilla oat milk, chilled' },
      { amount: '1', unit: 'cup', name: 'ice cubes' },
      { amount: '1', unit: 'pinch', name: 'vanilla extract (optional)' },
    ],
    steps: [
      'Sift matcha powder into a small bowl to remove lumps.',
      'Add hot water and whisk vigorously until smooth and frothy.',
      'Stir in maple syrup until dissolved.',
      'Fill a glass with ice cubes.',
      'Pour in the chilled oat milk, then slowly add the matcha mixture.',

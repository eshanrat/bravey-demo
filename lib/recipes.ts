...
const recipes: Recipe[] = [
  ...
  },
  {
    ...
    description: 'Creamy avocado mash on sourdough toast topped with a perfectly poached egg and chili flakes.',
    category: 'breakfast',
    prepMins: 10,
    cookMins: 5,
    servings: 1,
    ...
    steps: [
      'Toast the sourdough slice until golden brown.',
      ...
      'Poach for 3-4 minutes until white is set but yolk is still runny.',
      'Meanwhile, mash the avocado with salt and pepper.',
      'Spread avocado on toast, top with poached egg, and sprinkle with chili flakes.',
    ],
  ...
  },
  {
    ...
    description: 'Cold brew coffee with vanilla syrup and milk, served over ice for a refreshing caffeine boost.',
    category: 'drink',
    prepMins: 5,
    cookMins: 0,
    servings: 1,
    ...
    ingredients: [
      { amount: '200', unit: 'ml', name: 'cold brew coffee' },
      { amount: '100', unit: 'ml', name: 'milk of choice' },
      { amount: '2', unit: 'tbsp', name: 'vanilla syrup' },
    ...
    steps: [
      ...
      'Slowly pour the milk to create a layered effect.',
      'Stir before drinking and add sugar if desired.',
    ],
  ...
  },
  {
    ...
    description: 'Light and airy pancakes perfect for weekend breakfast, served with maple syrup and fresh berries.',
    category: 'breakfast',
    prepMins: 10,
    cookMins: 15,
    servings: 4,
    ...
    steps: [
      ...
      'Pour 1/4 cup of batter per pancake and cook until bubbles form on surface.',
      'Flip and cook until golden brown. Serve immediately with syrup and berries.',
    ],

...
const recipes: Recipe[] = [
  ...
  },
  {
    ...
    description: 'Light and airy pancakes perfect for weekend mornings. Serve with maple syrup and berries.',
    category: 'breakfast',
    prepMins: 10,
    cookMins: 15,
    servings: 4,
    ...
    steps: [
      ...
      'Pour wet ingredients into dry ingredients and gently fold until just combined. Don\'t overmix.',
  ...
  {
    id: '5',
    title: 'Fresh Green Smoothie',
    description: 'Nutrient-packed smoothie with spinach, banana, and mango. A refreshing healthy drink.',
    category: 'drink',
    prepMins: 5,
    cookMins: 0,
    servings: 2,

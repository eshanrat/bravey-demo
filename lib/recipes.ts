...
const recipes: Recipe[] = [
  ...
  },
  {
    ...
    description: 'Creamy smashed avocado on sourdough with a perfectly runny poached egg and chilli flakes.',
    category: 'breakfast',
    prepMins: 5,
    cookMins: 10,
    servings: 1,
    ...
    ingredients: [
      ...
      { amount: '½', unit: 'tsp', name: 'chilli flakes' },
    ...
    steps: [
      ...
      'Bring a pan of water to a gentle simmer and add the vinegar.',
      'Crack each egg into a small cup, swirl the water, and slide the egg in. Poach for 3 minutes.',
      'Spread mashed avocado on toast, top with a poached egg, and finish with chilli flakes.',
    ],
  ...
  },
  {
    id: '5',
    title: 'Mango Lassi',
    description: 'A chilled, creamy Indian yoghurt drink blended with ripe mango and a hint of cardamom.',
    category: 'drink',
    prepMins: 5,
    cookMins: 0,
    servings: 2,
    imageUrl: 'https://images.unsplash.com/photo-1605197161470-5a486b97bba7?w=800&q=80',
    ingredients: [
      { amount: '2', unit: '', name: 'ripe mangoes, peeled and diced' },
      { amount: '250', unit: 'ml', name: 'plain yoghurt' },
      { amount: '150', unit: 'ml', name: 'cold milk' },
      { amount: '2', unit: 'tbsp', name: 'honey or sugar' },
      { amount: '¼', unit: 'tsp', name: 'ground cardamom' },
      { amount: '6', unit: '', name: 'ice cubes' },
    ],
    steps: [
